...
RoxyUtils.LoadConfig = function(){
  $.ajax({
      url: jqx_config.basePath + 'fuel/modules/fileman/assets/conf.json',
      dataType: 'json',
      async:false,
...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.GetHtml = function(){
     ...
     html += '<div><img src="'jqx_config.basePath + 'fuel/modules/fileman/assets/images/'+(this.dirs > 0?'dir-plus.png':'blank.gif')+'" class="dirPlus" width="9" height="9">';
  ...
  this.Select = function(selectedFile){
    ...
    el.children('img.dir').prop('src', jqx_config.basePath + 'fuel/modules/fileman/assets/images/folder.png');
    this.SetStatusBar();
...
function dragFileOver(){
  $(this).children('img.dir').attr('src', jqx_config.basePath + 'fuel/modules/fileman/assets/images/folder-green.png');
}
function dragFileOut(){
  $('#pnlDirList').find('img.dir').attr('src', jqx_config.basePath + 'fuel/modules/fileman/assets/images/folder.png');
}
...
function makeDragDir(e){
  ...
  return '<div class="pnlDragDir" data-path="'+f.fullPath+'"><img src="'+jqx_config.basePath + 'fuel/modules/fileman/assets/images/folder.png" align="absmiddle">&nbsp;'+f.name+'</div>';
}
...
function switchView(t){
  ...
  if(t == 'thumb'){
    $('#pnlFileList .icon').attr('src', jqx_config.basePath + 'fuel/modules/fileman/assets/images/blank.gif');
