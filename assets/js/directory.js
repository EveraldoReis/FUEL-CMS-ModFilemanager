...
function Directory(fullPath, numDirs, numFiles){
  ...
  this.GetHtml = function(){
     ...
     html += '<div><img src="'+jqx_config.basePath + 'fuel/modules/fileman/assets/images/'+(this.dirs > 0?'dir-plus.png':jqx_config.basePath + 'fuel/modules/fileman/assets/images/blank.gif')+'" class="dirPlus" width="9" height="9">';
     html += '<img src=' + jqx_config.basePath + '"fuel/modules/fileman/assets/images/folder.png" class="dir"><span class="name">'+this.name+' ('+this.files+')</span></div>';
     html += '</li>';
  ...
  this.SetOpened = function(){
    ...
    if(li.find('li').length < 1)
      li.children('div').children('.dirPlus').prop('src', jqx_config.basePath + 'fuel/modules/fileman/assets/images/blank.gif');
    else if(this.IsExpanded())
      li.children('div').children('.dirPlus').prop('src', jqx_config.basePath + 'fuel/modules/fileman/assets/images/dir-minus.png');
    else
      li.children('div').children('.dirPlus').prop('src', jqx_config.basePath + 'fuel/modules/fileman/assets/images/dir-plus.png');
  };
