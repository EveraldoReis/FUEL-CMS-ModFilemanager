...
class Fuel_fileman extends Fuel_advanced_module {

	public $name = "fileman"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->fileman->my_method()
	 */
}